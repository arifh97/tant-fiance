    ...
    <div className='bg-[#090B12] px-5 md:px-7 lg:px-9 py-5 md:py-6 lg:py-7 flex items-center justify-between'>
      ...
      <div className="flex items-center ml-auto gap-3">
        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <g clip-path="url(#clip0_131_1128)">
        ...
        <button>
          <Avatar width={50}   radius="full"  height={50} className="border-2 rounded-full" style={{ borderColor: '#272F43' }} src="/src/assets/img/Avater.png" />
      </button>
      </div>
    </div>
  )
