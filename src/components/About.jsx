...
export default function About() {
  const about_card = [
    {
      icon: `<svg class="mx-auto md:mx-0" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      icon: `<svg class="mx-auto md:mx-0" width="39" height="40" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Container className='relative z-[2]' rowClass='items-center'>
        <Col className="w-full md:w-7/12 xl:w-6/12">
          <motion.div
            ...
            <p
              className="text-sm md:text-xl lg:text-[22px] !leading-[160%] mt-5 text-[#B2B0B9]">At TANT Finance, we're dedicated to revolutionizing the world of decentralized finance (DeFi) by combining innovative technologies with unparalleled opportunities for growth and prosperity.</p>
            <p
              className="text-sm md:text-xl lg:text-[22px] !leading-[160%] mt-5 md:mt-7 lg:mt-10 text-[#B2B0B9]">Our platform harnesses the power of artificial intelligence (AI), primarily focused on lending, to optimize lending processes, improve risk assessment, and enhance overall user experience.</p>
          </motion.div>
        </Col>
